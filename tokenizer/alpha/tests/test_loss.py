...
def test_generator_loss():
    ...
    try:
        ...
        print(f"✓ Generator loss with mask computed successfully")
        ...
        print(f"✗ Error in compute_generator_loss: {str(e)}")
        raise
...
def test_discriminator_loss():
    ...
    try:
        ...
        print(f"✓ Discriminator hinge loss computed successfully")
        ...
        print(f"✗ Error in compute_discriminator_loss: {str(e)}")
        raise
...
def test_shape_compatibility():
    ...
    for audio_length, encoder_length in [(12000, 25), (48000, 100)]:
        ...
        try:
            ...
            print(f"    ✓ Sequence lengths work correctly")
        except Exception as e:
            print(f"    ✗ Sequence lengths failed: {str(e)}")
...
def test_edge_cases():
    ...
    try:
        ...
        print(f"  ⚠ Mismatched shapes did not raise error (unexpected)")
    except Exception as e:
